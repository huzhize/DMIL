...
function gotopage5(pageIndex,currentPage,maxpage) {
	...
	if (pageIndex == null) {
		pageIndex = $("#pagination_page_projectAndOrder").val();

		if (pageIndex == "" || !isNumber(pageIndex) || pageIndex < 1) {
			$("#pagination_page_projectAndOrder").val("");
			$("#pagination_page_projectAndOrder")[0].focus();
			return false;
		}
...
function gotopage7(pageIndex,currentPage,maxpage) {
	if (pageIndex == null) {
		pageIndex = $("#pagination_page1").val();

		if (pageIndex == "" || !isNumber(pageIndex) || pageIndex < 1) {
			$("#pagination_page1").val("");
			$("#pagination_page1")[0].focus();
			return false;
		}
